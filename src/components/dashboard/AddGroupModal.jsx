...
export default function AddGroupModal({ open, onClose, onConfirm }) {
  if (!open) {
    return null
  }
  ...
  return (
    ...
    >
      <div
        className="flex min-h-[29rem] w-[32.125rem] max-w-full flex-col items-center gap-[2rem] rounded-[1.25rem] bg-white p-[3.125rem] shadow-[0_0.25rem_0.25rem_rgba(0,0,0,0.25)] backdrop-blur-[0.4063rem]"
        ...
        <div className="flex w-full max-w-[25.875rem] flex-col gap-5 self-stretch">
          <Field label="Group Name">
            <input
              ...
              className="h-[3.4375rem] w-full rounded-[0.5rem] border border-[#D0D5DD] bg-white px-[0.875rem] py-[0.625rem] font-['Inter'] text-[1rem] font-normal leading-[1.5rem] text-[#344054] shadow-[0_0.0625rem_0.125rem_rgba(16,24,40,0.05)] placeholder:text-[#667085] focus:outline-none focus:ring-2 focus:ring-[#2970FF]/25"
            />
          </Field>
